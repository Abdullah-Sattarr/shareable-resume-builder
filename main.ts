...
const shareableresumeLinkContainer = document.getElementById('shareable-link-container') as HTMLDivElement;
const shareableresumeLinkElement = document.getElementById('shareable-link') as HTMLAnchorElement;
const downloadresumePdfButton = document.getElementById('download-pdf') as HTMLButtonElement;
